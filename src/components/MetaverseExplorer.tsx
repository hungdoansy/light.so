        ...
        <div className="relative h-full text-center">
            <div className="md:hidden">
                ...
                >
                    <img
                        alt="Light"
                        sizes="100vw"
                        srcSet="/bgHeroLight.svg 640w, /bgHeroLight.svg 750w, /bgHeroLight.svg 828w, /bgHeroLight.svg 1080w, /bgHeroLight.svg 1200w, /bgHeroLight.svg 1920w, /bgHeroLight.svg 2048w, /bgHeroLight.svg 3840w"
                        src="/bgHeroLight.svg"
                        decoding="async"
                        data-nimg="fill"
                ...
                >
                    ...
                    >
                        <img
                            alt=""
                            aria-hidden="true"
                            src="data:image/svg+xml,%3csvg%20xmlns=%27http://www.w3.org/2000/svg%27%20version=%271.1%27%20width=%271920%27%20height=%271920%27/%3e"
                            style={{
                                display: "block",
                                maxWidth: "100%",
                                width: "initial",
                    ...
                    <img
                        alt="Light"
                        draggable="false"
                        srcSet="/bgHeroLight.svg 1x, /bgHeroLight.svg 2x"
                        src="/bgHeroLight.svg"
                        decoding="async"
                        data-nimg="intrinsic"
                        className="pointer-events-none object-cover object-center"
            ...
            <div className="absolute inset-x-0 bottom-0 z-0 md:bottom-0 xl:bottom-32 2xl:top-40">
                ...
                >
                    ...
                    <img
                        alt="Light"
                        srcSet="/bgHeroPlanets.svg 1x, /bgHeroPlanets.svg 2x"
            ...
            <div className="container relative mx-auto px-4 pt-32 pb-48 md:py-24 lg:py-32 lg:px-8 xl:pt-80 xl:pb-64">
                <div className="relative z-20 px-8 text-center sm:px-16">
                    <div className="inline-block w-24 lg:w-full">
                        ...
                        >
                            ...
                            <img
                                alt="App Icon"
                                draggable="false"
                                // srcSet="/icon.png&w=128&q=75 1x, /icon.png&w=256&q=75 2x"
                                src="/icon.png"
                                decoding="async"
                                data-nimg="intrinsic"
                                style={{
                    ...
                    <a
                        className="inline-flex items-center rounded-full bg-bg-darker py-3 px-6 text-base font-medium text-contrast-higher shadow-sm hover:bg-bg-light"
                        href="/explore"
                    >
                        <svg
                        ...
                        <span className="text-3xl">&nbsp;</span>Explore now
                    </a>
                </div>
            </div>
        </div>
...
export default MetaverseExplorer
